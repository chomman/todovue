...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'todovue';
    ...
    'jhipster.mail.from' = 'todovue@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'todovue API';
    'jhipster.swagger.description' = 'todovue API documentation';
    ...
    'eureka.instance.appname' = 'todovue';
    'eureka.instance.instanceId' = 'todovue:${random.value}';
