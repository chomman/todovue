...
export default class TodoComponentsPage extends AlertPage {
...
export class TodoDeleteDialog {
  ...
  title: ElementFinder = element(by.id('todovueApp.todo.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-todo'));
}
